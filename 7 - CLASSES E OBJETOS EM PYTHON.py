# -*- coding: utf-8 -*-
"""7 - ATIVIDADE PYTHON - CLASSES E OBJETOS.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lltb81Rt40wg8lIdAsVl-kXN0bwsJXk8
...
def main():
    ...
    # Criar objeto Retangulo com as medidas fornecidas
    ...
    # Considerando que o piso tem dimensões padrão e não há desperdício
    tamanho_piso = 1.0  # Em metros
    quantidade_pisos = area_local / tamanho_piso

    # Considerando que o rodapé tem dimensão padrão e não há desperdício
...
class Pessoa:
    ...
    def envelhecer(self, anos=1):
        self.idade += anos
        if self.idade < 21:
            # Por padrão, a cada ano que a pessoa envelhece, se ela tiver menos de 21 anos, ela cresce 0,5 cm
